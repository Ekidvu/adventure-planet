...
export const metadataInfo: metadataInfoProps[] = [
    {
        page: "/",
        titleName: "Главная",
        description: "Главная",
    },
    {
        page: "/about_us",
        titleName: "О нас",
        description: "О нас. Организация праздников",
    },
    {
        page: "/contacts",
        titleName: "Контакты",
    ...
    {
        page: "/shows",
        titleName: "Шоу-программы",
        description: "Шоу-программы",
    },
    {
        page: "/policy",
        titleName: "Политика конфиденциальности",
